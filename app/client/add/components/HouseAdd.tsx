...
export const HouseAdd = ({
    ...
    return (
        <>
            <form ref={formRef} className="flex flex-col w-full max-w-7xl items-center gap-2">
                <div className="flex w-full gap-4">
                    ...
                    <div className="w-4/12 h-full">
                        <div className="w-full items-center gap-2">
                            <div className="h-[800px] w-[640px] rounded-md overflow-hidden flex flex-col gap-4">
